      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input v-model="newService.service_b_price" class="form-control mb-2" type="number"
              placeholder="Base Price">
            <input v-model="newService.time_required" class="form-control mb-2" type="number"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input v-model="selectedService.service_b_price" class="form-control mb-2" type="number"
              placeholder="Base Price">
            <input v-model="selectedService.time_required" class="form-control mb-2" type="number"
              placeholder="Time Required">
          </div>
          <div class="modal-footer">
